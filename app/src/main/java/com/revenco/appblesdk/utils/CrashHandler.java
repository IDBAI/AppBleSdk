package com.revenco.appblesdk.utils;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                Toast.makeText(mContext, "程序出现了一些问题，正在重启...", Toast.LENGTH_LONG).show();
                Looper.loop();
                System.exit(0);
            }
        }.start();
...
//			if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            String path = Environment.getExternalStorageDirectory() + "/_xlog/";
...
//			}
            ...
            XLog.d(TAG, "an error occured while writing file..." + e);
        }
        return null;
    }
}